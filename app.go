...
type tienChainApp struct {
	*starter.AppStarter                 // tienChainApp extends starter.AppStarter
...
// TienChainApp returns a fully constructed SDK application
func NewTienChainApp(logger log.Logger, db dbm.DB) abci.Application {
